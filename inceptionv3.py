...
#Instancia o modelo InceptionV3 e descarta a última camada de 1000 neurôneos.
...
# Plotar o grafico training & validation accuracy values
...
# Plotar o grafico training & validation loss values
...
# indicando o caminho para a pasta de teste 
test_generator=test_datagen.flow_from_directory('/content/drive/My Drive/pasta', 
                                                 target_size=(224,224),
                                                 color_mode='rgb',
                                                 batch_size=1,
                                                 class_mode='categorical',
